...
class myEncoderDecoder(nn.Module):
    def __init__(self, cfg=None, norm_layer=nn.BatchNorm2d):
        ...
        from test_docker.src.models.DnCNN import make_net
        num_levels = 17
        out_channel = 1
    ...
    def encode_decode(self, rgb, modal_x):
        ...
        # cmx
        x, x_rgb_out, x_e_out = self.backbone(rgb, modal_x)  # mit_b2 out_channels = [64,128,320,512]
        out, feats, cx, c_inputs = self.decode_head(x, return_feats=True)
        ...
        return out, conf, det, cx, c_inputs, x_rgb_out, x_e_out
    ...
    def forward(self, rgb):
        ...
        out, conf, det, cx, c_inputs, x_rgb_out, x_e_out = self.encode_decode(rgb, modal_x)
        return out, conf, det, modal_x, cx, c_inputs, x_rgb_out, x_e_out
